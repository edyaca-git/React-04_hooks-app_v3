...
// puede estar fuera de este programa en un archivo aparte como un helper
// o utils.ts etc. pero para fines didácticos lo dejamos aquí
...
export const getScrambleWordInitialState = (): ScrambleWordState => {
