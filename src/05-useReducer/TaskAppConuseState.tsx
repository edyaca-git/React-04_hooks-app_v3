...
// este ejercicio nos muestra como gestionar el estado con useState
// en el siguiente ejercicio veremos como hacerlo con useReducer que para estos temas es mas adecuado
...
export const TaskAppConuseState = () => {
  ...
  const addTodo = () => {
    ...
    // las dos lineas siguientes son equivalentes, comento 
    // una de ellas para evitar duplicar la tarea
  ...
  const toggleTodo = (id: number) => {
    ...
    const updatedTodos = todos.map( todo => {
      // la siguiente linea es equivalente a las del if y return
