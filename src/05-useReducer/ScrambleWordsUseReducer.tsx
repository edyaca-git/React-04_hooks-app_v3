...
export const ScrambleWordsUseReducer = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // todo lo comentado de este metodo se sustituyó
    // por el uso de useReducer
    dispatch({
      type: "CHECK_ANSWER",
    });
    ...
    //   // Limpiar input
    //   setGuess("");
    //   // quitar la palabra actual del arreglo
    //   const newWords = words.slice(1);
    //   // actualizar el estado
    //   setWords(newWords);
    //   // actualizar la palabra actual y la desordenada
  ...
  const handlePlayAgain = () => {
    dispatch({
      type: "START_NEW_GAME",
      payload: getScrambleWordInitialState(),
    });
    // todo lo comentado de este metodo se sustituyó
    // por el uso de useReducer
